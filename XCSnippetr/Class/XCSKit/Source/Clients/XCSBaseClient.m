...
@interface XCSBaseClient () <NSURLSessionTaskDelegate>
@property (nonatomic, strong) NSURLSession *URLSession;
@property (nonatomic, strong) NSURLSessionDataTask *URLSessionTask;
@end

@implementation XCSBaseClient
...
{
    NSAssert([self class] != [XCSBaseClient class], @"Oops! You must subclass XCSBaseClient to use this method.");
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0ul), ^{
        ...
        id completionHandler = ^void(NSData *data, NSURLResponse *response, NSError *error) {
            ...
            if (!error && json[[self errorResponseKey]]) {
                ...
                error = [NSError errorWithDomain:XCSBundleIdentifier() code:400 userInfo:userInfo];
            }
