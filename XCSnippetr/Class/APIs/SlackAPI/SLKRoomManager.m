...
#define kCurrentAccount [SLKAccount currentAccount]
...
- (NSDictionary *)roomsListsForAccount:(SLKAccount *)account
{
...
- (NSArray *)allRoomsForAccount:(SLKAccount *)account
{
...
- (BOOL)hasRoomsForAccount:(SLKAccount *)account
{
...
- (NSArray *)roomsForAccount:(SLKAccount *)account type:(SLKRoomType)type
{
    if ([self hasRoomsForAccount:account]) {
...
- (NSArray *)roomNamesForAccount:(SLKAccount *)account type:(SLKRoomType)type
{
...
- (void)setRooms:(NSDictionary *)rooms forAccount:(SLKAccount *)account
{
